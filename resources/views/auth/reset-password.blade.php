        ...
        <div class="row justify-content-center">
            ...
            <div class="col-row-4">
                <div class="img-logo text-center mt-5">
                    <img src="{{ asset('assets/img/company.jpg') }}" style="width: 80px;">
                </div>
                <div class="o-hidden border-0 shadow-lg mb-3 mt-5">
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="{{ route('password.update') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $request->email ?? old('email') }}" required autocomplete="email" autofocus placeholder="Masukkan Alamat Email">
                                @error('email')
